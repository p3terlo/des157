(function () {
    ...
    alert('Hello! While testing this website, please keep in mind the following: 1) The transition from clicking submit to the storyline text 2) How easy it is to find the interactive elements 3) The overall color scheme, font, and feel of the page in relation to the retro Mario theme')
